...
<body class="fullscreen">
  ...
  <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
      <a onclick="switchiframe('./rethinkdb-admin/')" class="choice list-group-item list-group-item-action bg-light">Database</a>
      <?php
  ...
  <div id="page-content-wrapper">
    ...
    <div class="container-fluid container-extend">
      <iframe frameborder="0" id="iframe" src="./rethinkdb-admin/" class="all">
      </iframe>
    </div>
  </div>
